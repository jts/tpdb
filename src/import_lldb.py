# From: https://opensource.apple.com/source/lldb/lldb-300.2.47/utils/vim-lldb/python-vim-lldb/import_lldb.py.auto.html
...
def import_lldb():
  ...
  try:
    ...
    if not os.path.exists(lldb_minus_p_path):
      ...
      sys.path.append(str(lldb_minus_p_path))
      import lldb
      return True
